...
function fs2_viewAllfriend()
{
	...
	if($(fsgnrname).style.display == "block")
	{
		...
		$(xxshname).innerHTML = '<img src="../i/xx_xx1.gif" class="cp" onmouseover="this.src=\'../i/xx_xx2.gif\';" onmouseout="this.src=\'../i/xx_xx1.gif\';" alt="选择好友" />';
	}
	else
	{
		var url = "/interface/suggestfriend.php";
		...
		$(xxshname).innerHTML = '<img src="../i/xx_xs1.gif" class="cp" onmouseover="this.src=\'../i/xx_xs2.gif\';" onmouseout="this.src=\'../i/xx_xs1.gif\';" alt="选择好友" />';
