  ...
  <DIV class="deal_left">
		 ...
		 <DIV class="dealinfo">
			<DIV class="">
				<DIV onmouseover="javascript:$(&#39;img141434&#39;).style.display=&#39;block&#39;;" onmouseout="javascript:$(&#39;img141434&#39;).style.display=&#39;none&#39;;">
					...
					<SPAN class="l f12 c9"><?if(isset($master_user))
											{
											?>
											( 目前<?= $gender ?>是<?= $master_user["userinfo"]["nickname"] ?>的奴隶 )
											<?
											}
											?></SPAN>
				</DIV>
			...
			{?>
			<DIV class="r wysft" style="margin-right:1px;"><span onclick="javascript:freeslave(<?= $user["User"]["uid"] ?>);" style="cursor:pointer;">我要释放他</span></DIV>
			<?
			}
			else
			{?>
	  ...
	  <DIV class="deal_right">
			...
			{ ?>
			<DIV id="nohost" class="ml20 mt5 c9" >目前<?= $gender ?>是自由身<BR><BR><BR><BR></DIV>
			<? 
			}
			else
			{
			...
			<?php
			 ...
			 {
			 ?> 
				<DIV id="noslavelist" class="ml20 c9" >目前<?= $gender ?>没有一个奴隶</DIV>
			 <?
			 }
			 else
			 {
