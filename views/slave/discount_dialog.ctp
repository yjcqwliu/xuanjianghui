<div style="display:block;width:445px;margin:0 auto;"> 
	<div   style="height:390px;padding-top:136px;"> 
		...
		<input type="hidden" name="verify" value="3639191_1028_3639191_1229518704_d8bf1e72df1d98078228594058694181"> 
		<input type="hidden" name="slaveuid" value="13310698"> 
		
		<div class="tac f14"><b><span class="sl"><?= $slaveuser["userinfo"]["nickname"] ?></span>目前的身价是<strong class="dgreen">&yen;<?= $slaveuser["publicinfo"]["money"] ?></strong></b></div> 
