...
<?php echo $form->create(array('action'=>'buy')); ?>
	...
	<div class="c9" style="width:200px;margin:5px auto;">
		...
		{?>
		<div class="l" style="width:90px;"><?= $user["User"]["gender"] ?>的上次身价</div>
		...
		<div class="l" style="width:90px;"><?= $user["User"]["gender"] ?>的收益</div>
		...
		<div class="l" style="width:90px;margin-top:0px !important;margin-top:-10px;"><?= $user["User"]["gender"] ?>的现在身价</div>
	...
	<div class="f12 l mt15 " style="padding-left:110px;">给<?= $user["User"]["gender"] ?>起个绰号：</div>
...
<div style="padding:10px 150px;">
	<div class="rbs1">
		<input name="submit" type="submit" value="立即购买<?= $user["User"]["gender"] ?>" class="rb1-12" onmouseover="this.className='rb2-12';" onmouseout="this.className='rb1-12';" style="padding:2px 15px;" /></div>
</div>
</form>
