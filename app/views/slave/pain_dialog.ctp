...
<div style="display:block;width:445px;margin:0 auto;">
	...
	<div class="tac f14 mb10"><b>你要怎么整<span class="sl"><?= $slaveuser["userinfo"]["nickname"] ?></span>呢？</b></div>
	<div class="comp_list mb10">
	<?
	$i = -3;
	foreach($done_pain as $key => $value)
	{ 
	$i++;
	if($i > $sell_count)break;
	?>
	<ul class="fc">
		<li><input type="radio" name="paintype" value="<?= $key ?>"><?= $value ?></li>
	</ul>
	<?
	}
	?>
