...
var g_verify = "3639191_1028_3639191_1228628511_6d707c7c81549991e58c3fe01cf2faf2";
	  ...
	  <div class="deal_left">
		 ...
		 <div class="dealinfo">
			<div class="">
				<strong class="f14 dblue"><?= $user["userinfo"]["nickname"]?></strong>
				<?
				if(!empty($user["User"]["master_id"]) && isset($master_user["userinfo"]["nickname"]))
				{
				?>
				<span class='c6 f14' title='主人起的绰号'><?= $user["User"]["nickname"] ?></span>
				&nbsp;&nbsp;<span class="f12 c9">
		 ...
		 <?
			 ...
			 ?> 
					 ...
					 <div class="l"> 
					  <div class="dealimg2">
					  <?= $html->image($link->show_userpic($slave["userinfo"]["userpic"],2),array('url' => "friend?id=".$slave["User"]["uid"])); ?>
					  </div> 
					  <div class="c"></div> 
					</div> 
					<div class="l" style="margin-left:10px;width:380px; line-height:180%;"> 
						...
						<div class="r wysft"><span onclick="javascript:freeslave(<?= $slave["User"]["uid"] ?>);" style="cursor:pointer;">我要释放<?= $slave["User"]["gender"] ?></span></div> 
						<div class="r wysft"><span onclick="javascript:discountslave(<?= $slave["User"]["uid"] ?>);" style="cursor:pointer;">打折处理</span></div> 
						<div class="r wysft"><span onclick="javascript:painslave(<?= $slave["User"]["uid"] ?>);" style="cursor:pointer;">整<?= $slave["User"]["gender"] ?></span></div> 
						<div class="r wysft"><span onclick="javascript:comfortslave(<?= $slave["User"]["uid"] ?>);" style="cursor:pointer;">安抚<?= $slave["User"]["gender"] ?></span></div> 
						<div class="c"></div> 
						<div class="djl"> 
							<div class="l"> 
		...
		?>
		 ...
		 <div class="ml10">
			...
			<div class="l" style="padding:3px 2px 0px 0px; position:relative;margin:3px 2px 0 0;">
				<div id="xx_sh" onclick="fs2_viewAllfriend();"><?php echo $html->image('xx_xx1.gif',array('alt'=>'选择好友','class'=>'cp','onmouseover'=>"this.src='../webroot/img/xx_xx2.gif';",'onmouseout'=>"this.src='../webroot/img/xx_xx1.gif';"))?>
				</div>
				<a href="javascript:selslave();" class="sl">我能买的人</a>
				...
				<div class="tac p5"><div class="gbs1"><input type="button" id="btn_qd" value="确定" title="确定" class="gb1-12" onmouseover="this.className='gb2-12';" onmouseout="this.className='gb1-12';" onclick="fs2_viewAllfriend();" /></div><div class="c"></div></div>
				...
				?>
					<div class="p7_0">
						...
						<div class="histy_mx">
							...
							<div class="gw13 tar" style="font-size:9px;"></div>
							<div class="c"></div>
						</div>
						<div class="c"></div>
					</div>
